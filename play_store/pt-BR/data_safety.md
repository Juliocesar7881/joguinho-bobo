...
O app grava somente o progresso por modo e categoria de tamanho, o último tamanho e nível abertos, as tentativas, os rascunhos e a preferência de som de acerto no armazenamento privado do Android. Esses dados não saem do aparelho. O usuário pode apagá-los em **Configurações → Apps → LexiNexo → Armazenamento → Limpar dados** ou ao desinstalar o app.
