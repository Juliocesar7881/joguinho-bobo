...
melhor a experiência do jogo.

## Ícone e feature graphic
...
a pasta `mobile-branding/` pelo gerador do pacote final.

## Screenshots de telefone

Envie como **Telefone**, nesta ordem:

| Ordem | Arquivo | Texto alternativo |
|---:|---|---|
| 1 | `screenshots/phone/04-jogo-dicas-bilingues.png` | Dicas em português e inglês, tabuleiro e teclado QWERTY adaptativo de três linhas. |
...
Envie como **Tablet de 7 polegadas** e reutilize o mesmo conjunto em **Tablet de
10 polegadas**, nesta ordem:

| Ordem | Arquivo | Texto alternativo |
|---:|---|---|
| 1 | `screenshots/tablet/03-jogo-dicas-bilingues.png` | Dicas bilíngues, tabuleiro e teclado de três linhas centralizados no tablet. |
| 2 | `screenshots/tablet/04-vitoria.png` | Resultado de vitória no tablet com palavra correta e ações da partida. |
| 3 | `screenshots/tablet/01-tamanhos.png` | Categorias de 3 a 8 letras organizadas em uma tela ampla. |
| 4 | `screenshots/tablet/02-niveis-5-letras.png` | Grade da categoria de cinco letras adaptada à tela do tablet. |

Todas medem 1440×2560 e são PNG RGB de 24 bits sem alpha.

## Vídeo

Vídeo promocional do YouTube é opcional e não foi criado. Não é necessário para
